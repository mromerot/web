...
## Índice Municipal del Riesgo de Desastres Ajustado por Capacidades 2019

Índice Municipal del Riesgo de Desastres Ajustado por Capacidades (2019). [*Link*](https://www.dnp.gov.co/LaEntidad_/subdireccion-general-prospectiva-desarrollo-nacional/direccion-ambiente-desarrollo-sostenible/Paginas/indice-municipal-de-gestion-de-riesgo-ajustado-por-capacidades.aspx)

![Indice Municipal del Riesgo](images/dnp-imrac.png){width="300"}
...
## Marco Estratégico de Gestión Integral del Riesgo de Desastres (MEGIR) 2025

Marco Estratégico de Gestión Integral del Riesgo de Desastres (MEGIR). [*Link*](https://portal.gestiondelriesgo.gov.co/marcoestrategico)

![MEGIR](images/megir.jpg{width="300"}
...
# Otras fuentes de datos en riesgo de desastres

::: panel-tabset
## GAR

[Global Assessment Report on Disaster Risk Reduction (GAR)](https://www.undrr.org/gar)

[![https://www.undrr.org/gar](images/GAR.png){width="300"}](https://www.undrr.org/gar)
