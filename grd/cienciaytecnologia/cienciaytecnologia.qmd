...
| **2022** | **Key Recommendations for a Strengthened Use of Science and Technology in DRR in the Americas and the Caribbean** | Informe regional de la Oficina Regional de UNDRR para las Américas y el Caribe que sistematiza recomendaciones clave para fortalecer el uso de la ciencia y la tecnología en la gestión del riesgo de desastres en la región, en el marco de la implementación del Marco de Sendai. | [Key recommendations – UNDRR](https://www.undrr.org/publication/key-recommendations-strengthened-use-science-and-technology-disaster-risk-reduction) |
...
### **Key Recommendations Américas**

[![](https://www.un-spider.org/sites/default/files/UNDRR_KeyRec_Cover.PNG){fig-align="left" width="250"}](https://www.undrr.org/publication/key-recommendations-strengthened-use-science-and-technology-disaster-risk-reduction)
