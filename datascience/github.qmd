...
-   GitHub Skills. [*Link*](https://skills.github.com/) *\<— recomendado !*
...
**Fusión en Git (Git merge)**: El proceso de combinar dos ramas en Git.
...
**ID de confirmación o hash**: Un identificador único para cada confirmación, que se utiliza para cambiar a diferentes puntos de guardado.
