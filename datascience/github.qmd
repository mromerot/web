...
## Definiciones 
Fuente ([*link*](https://intellipaat.com/blog/tutorial/devops-tutorial/git-cheat-sheet/#key_terminologies_in_git))
...
-   **Clonación**: Es la acción de crear un clon o copia de un repositorio en un nuevo directorio.
...
-   **Confirmar y subir/enviar (Commit and push)**: Es el proceso de guardar los cambios locales mediante un commit y luego enviarlos (push) al repositorio remoto para compartirlos con otros colaboradores.

-   **Rama (Branch)**: Una rama es una copia del proyecto que se utiliza para trabajar en un entorno aislado sin afectar al proyecto principal.
